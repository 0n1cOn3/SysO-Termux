...
█═══════════════════════════════════════█
█ [${blanco}88${verde}] ┃ ${blanco}Email-Supplant       ${verde}┃ ${blanco}NO ROOT ${verde}█
█═══════════════════════════════════════█
█ [${blanco}89${verde}] ┃ ${blanco}evillimiter          ${verde}┃ ${rojo}(ROOT)  ${verde}█
█═══════════════════════════════════════█
█ [${blanco}90${verde}] ┃ ${blanco}spiderfoot           ${verde}┃ ${blanco}NO ROOT ${verde}█
█═══════════════════════════════════════█
█ [${blanco}91${verde}] ┃ ${blanco}instaloader          ${verde}┃ ${blanco}NO ROOT ${verde}█
█═══════════════════════════════════════█
