...
echo -e "alias SysO-GoPh='clear && cd ${HOME}/go/src/github.com/gophish/gophish && sudo ./gophish'" >> ${PREFIX}/etc/fish/config.fish
echo -e "alias SysO-Bot='termux-open-url https://t.me/Termux_Hacking_bot'" >> ${PREFIX}/etc/fish/config.fish
echo -e "alias SysO-Rsf='clear && cd ${HOME}/routersploit && sudo python rsf.py'" >> ${PREFIX}/etc/fish/config.fish
